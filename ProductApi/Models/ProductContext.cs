            ...
            modelBuilder.Entity<Product>().HasData(
                new Product[]
                {
                    new Product {Id=1, Url="someurl1", Name="Pink boots", Brand="Bootsy",
                        Currency="RUB", Price=8999, Discount=0, Description="Pink boots from Bootsy Inc.",
                    ...
                    new Product {Id=2, Url="someurl2", Name="Sand pants", Brand="Sandy's",
                        Currency="RUB", Price=4999, Discount=0, Description="Sand pants from Sandy's Inc.",
                    ...
                    new Product {Id=3, Url="someurl3", Name="Stratocaster", Brand="Fender",
                        Currency="USD", Price=699, Discount=0, Description="Surf green Fender Stratocaster",
